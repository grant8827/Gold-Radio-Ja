...
function AboutOwner() {
  return (
    <div>
        <div className='aboutOwner' style={{display:'flex', justifyContent:'center'}}>
            <img style={{width:'250px', margin:'20px'}} src={require('../assets/images/ivanhallimg.png')}/>
            
            <div className='owerDetails' style={{margin:'20px'}}>
